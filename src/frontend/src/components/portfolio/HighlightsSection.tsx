        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {highlights.map((highlight) => {
            ...
            return (
              <Card
                key={highlight.label}
                className="border-border/60 bg-background/50 backdrop-blur-sm transition-all duration-200 hover:shadow-lg hover:border-primary/30 hover:-translate-y-1"
              >
